...
import (
	...
	"github.com/garethjevans/stash/pkg/version"
...
func init() {
	...
	RootCmd.AddCommand(cmd.NewStashCmd())
	RootCmd.AddCommand(cmd.NewStashPopCmd())
...
var RootCmd = &cobra.Command{
	Use:   "stash",
	Short: "provides commands for interacting with different stash providers",
	Long:  `a CLI used to interact with different stash providers`,
